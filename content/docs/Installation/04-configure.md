---
title: "Secure and Rename Your Router"
weight: 4
---
...
2. In the **Basic** tab:
   ...
   Save the changes.
   ![RaspAP admin ssid change page](../../../screenshots/Rasp-AP-Change-ssid.png "Admin authentication settings (placeholder)")
3. In the **Security** tab:
   - Set a new **Pre-shared key (PSK)**, which is your Wi-Fi password.
   Save the changes.
   ![RaspAP admin password settings page](../../../screenshots/Rasp-AP-Change-PW.png "Admin authentication settings (placeholder)")
