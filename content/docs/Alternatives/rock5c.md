...
# Rock 5C
---
- The [Rock 5C](https://radxa.com/products/rock5/5c/) is a high performance single-board computer (SBC) from Radxa, designed for power users, developers, and AI applications.
- Price
    - Looking at the ±$100 range.
- **Pros**: 
