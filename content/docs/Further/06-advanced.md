---
title: "Advanced and Manual Installation"
weight: 6
---
...
1. Flash a fresh **Raspberry Pi OS** image to the SD card using Raspberry Pi Imager.
2. Boot the Pi and update packages:
   ...
   sudo reboot
3. Refer to RaspAP [official documentation](https://docs.raspap.com/get-started/manual/) for next steps.
